...
import { vecAdd, vecSub, vecMul, vecDiv, vecNeg } from "../../../../src/engine/core/vectorOps";
    ...
    function UI_render(this: TextBox) {
        ...
        if (this.isWorldEntity && camera !== null) {
            ...
            let posX = vecMul(vecSub(this.position.x, vecAdd(camera.position.x, camera.offset.x)), S)
            let posY = vecMul(vecSub(this.position.y, vecAdd(camera.position.y, camera.offset.y)), S)
