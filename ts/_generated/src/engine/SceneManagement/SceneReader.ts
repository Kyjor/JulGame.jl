        ...
        try {
            if (component.type == "Transform") {
                ...
                for (const animationFrame of animation.frames) {
                    ...
                    let framePaths = haskey(animation, "framePaths") ? String.(animation.framePaths) : String[]
                    newAnimations.push(JulGameAnimation(newAnimationFrames, animation.animatedFPS, framePaths))
                }
