module JulGame
    ...
    export IEntity, IUIElement, ITransform, IShape, ISoundSource, ISprite, IAnimator, ICollider, IObserver, IHistory, ICanvas
    ...
    using .CameraModule: Camera, pixels_per_world_unit
    export pixels_per_world_unit
