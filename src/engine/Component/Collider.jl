module ColliderModule
    ...
    function check_collision(colliderA::InternalCollider, colliderB::InternalCollider)
        ...
        posA = (colliderA.parent.transform.position + colliderA.offset) * su
        posB = (colliderB.parent.transform.position + colliderB.offset) * su
        colliderAXSize = colliderA.parent.transform.scale.x * colliderA.size.x * su
        colliderAYSize = colliderA.parent.transform.scale.y * colliderA.size.y * su
        colliderBXSize = colliderB.parent.transform.scale.x * colliderB.size.x * su
        colliderBYSize = colliderB.parent.transform.scale.y * colliderB.size.y * su
