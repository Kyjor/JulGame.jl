...
# module EntityManipulation
#     using CImGui
#     using ..JulGame
#     using ..JulGame.Math
    
#     # Import ManipulationArrows after it's been loaded
#     import ..ManipulationArrows

#     export handle_entity_manipulation, EntityManipulationMode
...
#             if ManipulationArrows.draw_position_arrows(pos_ref, grid_snap)
...
#             ManipulationArrows.draw_resize_handles(widget_pos, scale_ref, grid_snap, ManipulationArrows.Default)
...
#                 widget_pos = Math.Vector2(transform.position.x, transform.position.y)
#                 ManipulationArrows.draw_resize_handles(widget_pos, size_ref, grid_snap, ManipulationArrows.Default)
