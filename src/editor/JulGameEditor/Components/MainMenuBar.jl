...
function show_main_menu_bar(events)
    if CImGui.BeginMainMenuBar()
        ...
        #         @info "Trigger Undo | find me here: $(@__FILE__):$(@__LINE__)"
        #     end
        #     if CImGui.MenuItem("Redo", "CTRL+Y", false, false)  # disabled item
        #         @info "Trigger Redo | find me here: $(@__FILE__):$(@__LINE__)"
        #     end
        #     CImGui.Separator()
        #     if CImGui.MenuItem("Cut", "CTRL+X")
        #         @info "Trigger Cut | find me here: $(@__FILE__):$(@__LINE__)"
        #     end
        #     if CImGui.MenuItem("Copy", "CTRL+C")
        #         @info "Trigger Copy | find me here: $(@__FILE__):$(@__LINE__)"
        #     end
        #     if CImGui.MenuItem("Paste", "CTRL+V")
        #         @info "Trigger Paste | find me here: $(@__FILE__):$(@__LINE__)"
        #     end
        #     CImGui.EndMenu()
        # end
...
function ShowMenuFile(events)
    ...
    #     @info "Trigger New | find me here: $(@__FILE__):$(@__LINE__)"
    # end
    # if CImGui.MenuItem("Open", "Ctrl+O")
    #     @info "Trigger Open | find me here: $(@__FILE__):$(@__LINE__)"
    # end
    ...
    #     @info "Trigger Save As.. | find me here: $(@__FILE__):$(@__LINE__)"
    # end
    # CImGui.Separator()
    ...
    # end
    # CImGui.MenuItem("Checked", "", true) && @info "Trigger Checked | find me here: $(@__FILE__):$(@__LINE__)"
    # CImGui.MenuItem("Quit", "Alt+F4") && @info "Trigger Quit | find me here: $(@__FILE__):$(@__LINE__)"
end